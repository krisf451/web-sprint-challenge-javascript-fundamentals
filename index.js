...
// A: It can access the variable 'internal' because of the scope it is in. myFunction has a scope, and since nestFunction is inside of myFunction is will have access to all of myFunctions variables. This would be called function scope, or block scope.
...
console.log("topic 2, advanced array methods", animalNames(zooAnimals));
...
console.log("topic 2, advanced array methods .map", lowerCaseNames(zooAnimals));
...
console.log(
  "topic 2, advanced array methods .filter",
...
console.log("Request 4: .reduce", USApop(zooAnimals));
